...
void DrawMenuWindow()
{
	...
	ImGui::Begin(/*##menu*/XorStr<0x9A, 7, 0x2A9A8C6C>("\xB9\xB8\xF1\xF8\xF0\xEA" + 0x2A9A8C6C).s, nullptr, flags);
	{
		...
		draw->AddText({ pos.x + 710 - ImGui::CalcTextSize(/*v1.101 @ 2023*/XorStr<0xCD,14,0xF2A07708>("\xBB\xFF\xE1\xE1\xE1\xE3\xF3\x94\xF5\xE4\xE7\xEA\xEA" + 0xF2A07708).s).x, pos.y + 470 + 10 - ImGui::CalcTextSize(/*v1.101 @ 2023*/XorStr<0xCD,14,0xF2A07708>("\xBB\xFF\xE1\xE1\xE1\xE3\xF3\x94\xF5\xE4\xE7\xEA\xEA" + 0xF2A07708).s).y / 2 }, ImColor((int)(cvar.visual_menu_color_footer_text[0] * 255), (int)(cvar.visual_menu_color_footer_text[1] * 255), (int)(cvar.visual_menu_color_footer_text[2] * 255), Sakura::Menu::currentAlphaFade), /*v1.101 @ 2023*/XorStr<0xCD, 14, 0xF2A07708>("\xBB\xFF\xE1\xE1\xE1\xE3\xF3\x94\xF5\xE4\xE7\xEA\xEA" + 0xF2A07708).s);
