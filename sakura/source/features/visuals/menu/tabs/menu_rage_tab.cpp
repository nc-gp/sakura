...
void Sakura::Menu::Tabs::Rage::Aimbot()
{
	...
	ImGui::BeginChild(/*##ra2*/XorStr<0x40, 6, 0x6EE41BBA>("\x63\x62\x30\x22\x76" + 0x6EE41BBA).s, ImVec2(250, -1));
	{
		...
		Sakura::Menu::Widgets::Combo(
			...
			/*Field of view\0Distance\0Cycle*/XorStr<0xE1, 29, 0x121FAF75>("\xA7\x8B\x86\x88\x81\xC6\x88\x8E\xC9\x9C\x82\x89\x9A\xEE\xAB\x99\x82\x86\x92\x9A\x96\x93\xF7\xBB\x80\x99\x97\x99" + 0x121FAF75).s);
