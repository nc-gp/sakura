...
//bool Sakura::Menu::Widgets::List(float current_item, std::vector<std::string> items, int& item, ImColor color)
//{
//	const ImVec2 pos = ImGui::GetCurrentWindow()->DC.CursorPos;
//
//	ImGui::GetCurrentWindow()->DrawList->AddRectFilled({ pos.x, pos.y }, { pos.x + 250, pos.y + (16 * configs.size()) }, ImColor(0, 0, 0, 50), 4);
//
//	for (auto i = 0; i < items.size(); i++)
//	{
//		if (current_item == i)
//			ImGui::GetCurrentWindow()->DrawList->AddRectFilled({ pos.x, pos.y + (16 * i) }, { pos.x + 250, pos.y + 16 + (16 * i) }, Sakura::Menu::GetMenuColor(), 4);
//
//		const ImGuiID id = ImGui::GetCurrentWindow()->GetID(configs[i].c_str());
//
//		ImVec2 size = ImGui::CalcItemSize({ 250.f, 16.f }, 250.f, 16.f);
//
//		const ImRect bb({ pos.x, pos.y + (16 * i) }, { pos.x + size.x, pos.y + size.y + (16 * i) });
//		ImGui::ItemSize(bb);
//		if (!ImGui::ItemAdd(bb, id))
//			return false;
//
//		//ImVec2 size = { pos.x + 250, (pos.y + 16 + (i * 16)) };
//
//		//const ImRect bb(pos, ImVec2(pos.x + 250, (pos.y + 16 + (i * 16))));
...
//
//		if (hovered)
//			ImGui::GetCurrentWindow()->DrawList->AddRectFilled({ pos.x, pos.y + (16 * i) }, { pos.x + 250, pos.y + 16 + (16 * i) }, Sakura::Menu::GetMenuColor(0.3), 4);
//
//		if (held)
//			ImGui::GetCurrentWindow()->DrawList->AddRectFilled({ pos.x, pos.y + (16 * i) }, { pos.x + 250, pos.y + 16 + (16 * i) }, Sakura::Menu::GetMenuColor(0.6), 4);
//
//		if (pressed)
//			item = i;
//
//		ImGui::PushStyleColor(ImGuiCol_Text, (ImVec4)color);
//		ImGui::GetCurrentWindow()->DrawList->AddText({ pos.x + 4, pos.y + (16 * i) }, Sakura::Colors::White(), items[i].c_str());
//		ImGui::PopStyleColor();
//	}
//
//	return true;
